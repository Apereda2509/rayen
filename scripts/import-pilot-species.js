#!/usr/bin/env node
// scripts/import-pilot-species.js
//
// Importa las 5 fichas piloto desde data/seed/species.json a la base de datos.
// Uso: node scripts/import-pilot-species.js
//
...
async function main() {
  const file = path.join(__dirname, '../data/seed/species.json')
