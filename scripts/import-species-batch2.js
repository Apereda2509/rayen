#!/usr/bin/env node
// scripts/import-species-batch2.js
//
// Importa las 15 fichas del batch 2 desde data/seed/species-batch2.json a la base de datos.
// Uso: node scripts/import-species-batch2.js
//
...
async function main() {
  const file = path.join(__dirname, '../data/seed/species-batch2.json')
